...
<head>
  ...
  <title>Student Community - @yield('title')</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Student </b>Cummunity</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ asset('upload_images/'.session('profile_pic')) }}" class="user-image" alt="User Image">
              <span class="hidden-xs">{{ Auth::user()->name }}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{ asset('upload_images/'.session('profile_pic')) }}" class="img-circle" alt="User Image">
              ...
              <li class="user-body">
                <div class="row">
                  <div class="col-xs-4 text-center">
                    <a href="{{ (session('designation') == 'Teacher')?route('teachers.create'):route('profile.create') }}">Update Profile</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="#">Sales</a>
                  </div>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <!-- Sidebar user panel -->
      <div class="user-panel" style="padding: 10px 5px;">
        <div class="pull-left image">
          <img src="{{ asset('upload_images/'.session('profile_pic')) }}" class="img-circle" alt="User Image" style="height: 48px;">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> View</a></li>
            <li><a href="index2.html"><i class="fa fa-circle-o"></i> Update</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('friends.index') }}"><i class="fa fa-circle-o"></i> All Friends</a></li>
            <li><a href="{{ route('friends.create') }}"><i class="fa fa-circle-o"></i> Own batch</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="/teacherPost"><i class="fa fa-circle-o"></i> Teacher Post</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('attendance.create') }}"><i class="fa fa-circle-o"></i> Attendance Upload</a></li>
